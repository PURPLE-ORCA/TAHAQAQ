      ...
      >
        {step === 1 && (
          <LocationStep
            ...
            errorMsg={errorMsg}
            hasRouteEstablishment={hasRouteEstablishment}
            showManualSearch={showManualSearch}
            searchQuery={searchQuery}
            setSearchQuery={setSearchQuery}
            filteredEstablishments={filteredEstablishments}
            updateSelectedEstablishment={updateSelectedEstablishment}
            suggestedEstablishment={suggestedEstablishment}
            setDidSelectManually={setDidSelectManually}
        ...
        {step === 5 && (
          <ReviewStep
            selectedEstablishment={selectedEstablishment}
            selectedCategories={selectedCategories}
            selectedCategorySummaries={selectedCategorySummaries}
            comment={comment}
            setStep={setStep}
            setCurrentCategoryIndex={setCurrentCategoryIndex}
